...
INSERT INTO restaurant ('name', 'description', 'created_at', 'modified_at', 'owner_id', 'location_lat', 'location_lon') VALUES ('Test Restaurant', 'Test Restaurant Description', DATE('now'), DATE('now'), 5, 47.502837766383294, 19.04960806009421);
